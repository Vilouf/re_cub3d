...
/*   Updated: 2025/10/31 09:57:07 by pespana          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_walls(t_struct *data, int x, int y)
{
	if (x == 0 || y == 0)
		return (0);
	if (!(data->map[y + 1][x] == '1' || data->map[y + 1][x] == '0' || is_spawn_point(data->map[y + 1][x])))
		return (0);
	if (!(data->map[y - 1][x] == '1' || data->map[y - 1][x] == '0' || is_spawn_point(data->map[y - 1][x])))
		return (0);
	if (!(data->map[y][x + 1] == '1' || data->map[y][x + 1] == '0' || is_spawn_point(data->map[y][x + 1])))
		return (0);
	if (!(data->map[y][x - 1] == '1' || data->map[y][x - 1] == '0' || is_spawn_point(data->map[y][x - 1])))
		return (0);
	return (1);
...
int	set_player_data(t_struct *data, int x, int y)
{
